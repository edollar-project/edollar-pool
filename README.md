...
High performance Node.js (with native C addons) mining pool for CryptoNote based coins such as Bytecoin, DuckNote, Monero, QuazarCoin, Boolberry, Dashcoin, Edollar etc..
...
```bash
git clone https://github.com/edollar-project/edollar-pool.git pool
cd pool
npm update
```
...
Explanation for each field. Please note that this is an example, feel free to change it to working with your pool
```javascript
...
"poolServer": {
    ...
    /*CHANGE ME : change address*/
    "poolAddress": "edco64zh7dRFyB8dgDWZMLmzKBgGXYWZCG4NBF2VcvzEuiSQpMjyyiYJ1Ra696pZu56PPFQNBDdB1rZjyeX1RVKeWZgHg7pTxj"
    ...
    /* Set difficulty on miner client side by passing <address> param with .<difficulty> postfix
       minerd -u edq64zh7dRFyB8dgDWZMLmzKBgGXYWZCG4NBF2VcvzEuiSQpMjyyiYJ1Ra696pZu56PPFQNBDdB1rZjyeX1RVKeWZgHg7pTxj.5000 */
    "fixedDiff": {
        "enabled": true,
...
"payments": {
    ...
    "mixin": 4, //number of transactions yours is indistinguishable from
...
"blockUnlocker": {
    ...
    "coreDevDonation": 0.1 //0.1% donation to send to core devs - works with Bytecoin, Monero, Dashcoin, QuarazCoin, Fantoncoin, AEON, Edollar
},
...
var api = "http://poolhost:22022";

/* Pool server host to instruct your miners to point to.  */
var poolHost = "poolhost.com";

/* IRC Server and room used for embedded KiwiIRC chat. */
var irc = "irc.freenode.net/#edollar";
