...
var subAddressBase58Prefix = 12002;
...
function handleMinerMethod(method, params, ip, portData, sendReply, pushMessage){
    ...
    switch(method){
        case 'login':
            ...
            var loginAddressBase58Prefix = cnUtil.address_decode(new Buffer(login));
            if (addressBase58Prefix !== loginAddressBase58Prefix && subAddressBase58Prefix !== loginAddressBase58Prefix){
